  ...
  return {
    ...
    "session.created": async (input, output) => {
      await client.app.log({
        body: {
          service: "opsagent-shopify",
          level: "info",
          message: "opsagent-shopify plugin loaded",
          extra: { directory }
        }
      })
    }
